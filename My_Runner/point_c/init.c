...
{
    t_sprite dino2;
    dino2.rect = rect(0, 0, 115, 80);
    dino2.texture = sfTexture_createFromFile("dino_sprite2.png",
                                            NULL);
    dino2.sprite = sfSprite_create();
    sfSprite_setTexture(dino2.sprite, dino2.texture, false);
    dino2.scale = pos(1.85, 1.85);
    sfSprite_setScale(dino2.sprite, dino2.scale);
    dino2.pos = pos(10, 835);
    sfSprite_setPosition(dino2.sprite, dino2.pos);
    return (dino2);
}
